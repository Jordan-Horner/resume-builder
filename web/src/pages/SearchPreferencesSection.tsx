...
export function SearchPreferencesSection() {
  ...
  const optionalPreferenceCount = preferences.preferred_job_attributes.length + preferences.avoided_job_attributes.length;
