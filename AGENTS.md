...
This project is indexed by GitNexus as **resume-builder** (3141 symbols, 6948 relationships, 266 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| `gitnexus://repo/resume-builder/process/{name}` | Step-by-step execution trace |
