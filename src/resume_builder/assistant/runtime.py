...
from .openrouter import AgentProviderError, OpenRouterAdapter
from .state import AgentState, default_agent_state_path
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "serve":
            from .telegram import TelegramAdapter, run_telegram_service
        ...
        if args.command == "telegram-ids":
            from .telegram import discover_telegram_ids
