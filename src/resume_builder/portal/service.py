...
class DashboardService:
    ...
    def application_resume_preview(self, application_id: str) -> dict[str, Any]:
        from .career import resolve_application_resume_preview
    ...
    def job_filter_defaults(self) -> dict[str, Any]:
        from ..opportunities.cli import _load_preferences
        from .filters import ViewFilters
    ...
    def list_jobs(
        ...
        *,
        ...
        from .filters import ViewFilters, matches_view
